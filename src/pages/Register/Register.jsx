  ...
  return (
    <div className="register-container">
      ...
      <div className="car-stage">
        <img src={car} alt="Porsche GT3" className="car-image" />
      </div>
      <form className="register-form glass-card" onSubmit={handleSubmit}>
        ...
        <div style={{ margin: '5px' }}>
          <label for="login" className="account">
...
const formvalidationSchema = Yup.object({
  ...
  email: Yup.string().email('Please enter the valid email').required('please enter yor email'),
  password: Yup.string().min(8, 'Too short password').required('please fill the password'),
  phoneno: Yup.string()
